...
public class MemberDAO {
	...
	public int userCheck(String userid, String pwd) {
		int result = -1;
		String sql = "select pwd from shopmember where userid=?";
	...
	public MemberVO getMember(String userid) {
		...
		try {
			...
			if(rs.next()) {
				...
				mVo.setLogintype(rs.getInt("logintype"));
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	public int confirmID(String userid) {
		int result = -1;
		String sql = "select userid from shopmember where userid=?";
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public int insertMember(MemberVO mVo) {
		...
		try {
			...
			pstmt.setInt(6, mVo.getLogintype());
	...
	public int updateMember(MemberVO mVo) {
		int result = -1;
		String sql = "update shopmember set pwd=?, phone=?, email=? where userid=?";
